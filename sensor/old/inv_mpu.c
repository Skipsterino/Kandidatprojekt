...
#define log_i(...)     do {} while (0)
//static inline int log_i(const char *format, ...)
//{
//	va_list 	marker;
//	char message[50];
//
//	va_start(marker, format);
//	vsnprintf(message, 50, format, marker);
//	va_end(marker);
//
//	Serial.print(message);
//}

//static inline int log_e(const char *message)
//{
	//Serial.print(message);
//}

//#define i2c_write   i2c_write													(XXXXXXX)
