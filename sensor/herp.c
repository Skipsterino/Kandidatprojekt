...
const int delay_time = 20;		// tid i millisekunder (50 ger alltså ungefär 20Hz, lagom för US-sensorn)
...
double gyro_angular_rate[3];	// XXXX SKA GÖRAS LOKAL
...
int main(void)
{
	...
	TIMSK0 |= 1<<TOIE0;					//Tillåt overflow-avbrott på timer0
