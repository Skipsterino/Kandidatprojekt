...
\label{inv__mpu_8h_source}\index{sensor/inv\+\_\+mpu.\+h@{sensor/inv\+\_\+mpu.\+h}}
...
00028 \textcolor{preprocessor}{#include "millis.h"}
00029 
00030 \textcolor{preprocessor}{#ifndef \_INV\_MPU\_H\_}
00031 \textcolor{preprocessor}{#define \_INV\_MPU\_H\_}
00032 
00033 \textcolor{preprocessor}{#define MPU6050}
00034 
00035 \textcolor{preprocessor}{#define min(a,b) ((a<b)?a:b)}
00036 
00037 \textcolor{keyword}{inline} \textcolor{keywordtype}{void} get\_ms(\textcolor{keywordtype}{long} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} *timestamp)
00038 \{
00039     *timestamp = millis();
00040 \}
00041 
00042 \textcolor{keyword}{inline} \textcolor{keyword}{static} \textcolor{keywordtype}{void} \_\_no\_operation()
00043 \{
00044     \_delay\_ms(1);
00045 \}
00046 
00047 
00048 
00049 \textcolor{preprocessor}{#define INV\_X\_GYRO      (0x40)}
00050 \textcolor{preprocessor}{#define INV\_Y\_GYRO      (0x20)}
00051 \textcolor{preprocessor}{#define INV\_Z\_GYRO      (0x10)}
00052 \textcolor{preprocessor}{#define INV\_XYZ\_GYRO    (INV\_X\_GYRO | INV\_Y\_GYRO | INV\_Z\_GYRO)}
00053 \textcolor{preprocessor}{#define INV\_XYZ\_ACCEL   (0x08)}
00054 \textcolor{preprocessor}{#define INV\_XYZ\_COMPASS (0x01)}
00055 
\hypertarget{inv__mpu_8h_source.tex_l00056}{}\hyperlink{structint__param__s}{00056} \textcolor{keyword}{struct }\hyperlink{structint__param__s}{int\_param\_s} \{
00057 \textcolor{comment}{//#if defined EMPL\_TARGET\_MSP430 || defined MOTION\_DRIVER\_TARGET\_MSP430}
00058     \textcolor{comment}{//void (*cb)(void);}
00059     \textcolor{comment}{//unsigned short pin;}
00060     \textcolor{comment}{//unsigned char lp\_exit;}
...
00094     \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} lpa\_freq);
00095 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_gacc92fb1489ef32a04bcb6b0ebde4d657}{mpu\_set\_int\_level}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} active\_low);
00096 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_ga653cb855300bff9285ce4b8dca6a503b}{mpu\_set\_int\_latched}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} enable);
00097 
00098 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_ga68ed20e6c9663cd7c50469329af8715f}{mpu\_set\_dmp\_state}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} enable);
00099 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_gafe0f60ed0d7f8fd2dcd55d45b95a2363}{mpu\_get\_dmp\_state}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} *enabled);
00100 
00101 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_gaa95c7e216dcb2d888e9796001ca555f8}{mpu\_get\_lpf}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} *lpf);
00102 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_ga5661a9dee25152166769910767a2a93d}{mpu\_set\_lpf}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} lpf);
00103 
00104 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_gaf973c32c73ba912ff512aab948fc31ca}{mpu\_get\_gyro\_fsr}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} *fsr);
00105 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_gad09e6031c8677adc0b8a39b6deea8e27}{mpu\_set\_gyro\_fsr}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} fsr);
00106 
00107 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_gab6087a15ee23db23b6aec41590329a60}{mpu\_get\_accel\_fsr}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} *fsr);
00108 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_ga2713a96af104cfb2ae8e0ed4c3718119}{mpu\_set\_accel\_fsr}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} fsr);
00109 
00110 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_gade8589573d09e0f14b84130428f286df}{mpu\_get\_compass\_fsr}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} *fsr);
00111 
00112 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_ga023c0cc94aa8f162dc33b15048a49421}{mpu\_get\_gyro\_sens}(\textcolor{keywordtype}{float} *sens);
00113 \textcolor{keywordtype}{int} \hyperlink{group___d_r_i_v_e_r_s_ga620408949052b96e856cad920f856583}{mpu\_get\_accel\_sens}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} *sens);
00114 
